...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Indexer\Price\DefaultPrice implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTableStrategy');
        if (!$pluginInfo) {
            return parent::getTableStrategy();
        } else {
            return $this->___callPlugins('getTableStrategy', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setTypeId($typeCode)
    {
        ...
        if (!$pluginInfo) {
            return parent::setTypeId($typeCode);
        } else {
    ...
    public function setIsComposite($flag)
    {
        ...
        if (!$pluginInfo) {
            return parent::setIsComposite($flag);
        } else {
            return $this->___callPlugins('setIsComposite', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIsComposite()
    {
        ...
        if (!$pluginInfo) {
            return parent::getIsComposite();
        } else {
            return $this->___callPlugins('getIsComposite', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIdxTable($table = null)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getIdxTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRelationsByChild($childIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRelationsByChild($childIds);
        } else {
            return $this->___callPlugins('getRelationsByChild', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRelationsByParent($parentIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::getRelationsByParent($parentIds);
        } else {
            return $this->___callPlugins('getRelationsByParent', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function syncData()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('syncData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function insertFromTable($sourceTable, $destTable, $readToIndex = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::insertFromTable($sourceTable, $destTable, $readToIndex);
        } else {
            return $this->___callPlugins('insertFromTable', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function insertFromSelect($select, $destTable, array $columns, $readToIndex = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::insertFromSelect($select, $destTable, $columns, $readToIndex);
        } else {
    ...
    public function clearTemporaryIndexTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::clearTemporaryIndexTable();
        } else {
            return $this->___callPlugins('clearTemporaryIndexTable', func_get_args(), $pluginInfo);
        }
    }
