...
class Interceptor extends \Magento\Deploy\Package\Bundle\RequireJs implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Filesystem $filesystem, \Magento\Deploy\Config\BundleConfig $bundleConfig, \Magento\Framework\View\Asset\Minification $minification, $area, $theme, $locale, array $contentPools = array())
    {
        $this->___init();
