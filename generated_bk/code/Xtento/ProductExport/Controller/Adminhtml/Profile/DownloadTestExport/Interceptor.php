<?php
namespace Xtento\ProductExport\Controller\Adminhtml\Profile\DownloadTestExport;

/**
 * Interceptor class for @see \Xtento\ProductExport\Controller\Adminhtml\Profile\DownloadTestExport
 */
class Interceptor extends \Xtento\ProductExport\Controller\Adminhtml\Profile\DownloadTestExport implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\App\Action\Context $context, \Xtento\ProductExport\Helper\Module $moduleHelper, \Xtento\XtCore\Helper\Cron $cronHelper, \Xtento\ProductExport\Model\ResourceModel\Profile\CollectionFactory $profileCollectionFactory, \Magento\Framework\Filesystem $filesystem, \Magento\Framework\Registry $registry, \Magento\Framework\Escaper $escaper, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Framework\Stdlib\DateTime\Filter\Date $dateFilter, \Xtento\ProductExport\Helper\Entity $entityHelper, \Xtento\XtCore\Helper\Utils $utilsHelper, \Xtento\ProductExport\Model\ProfileFactory $profileFactory)
    {
        $this->___init();
