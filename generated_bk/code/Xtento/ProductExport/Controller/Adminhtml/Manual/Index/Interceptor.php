<?php
namespace Xtento\ProductExport\Controller\Adminhtml\Manual\Index;

/**
 * Interceptor class for @see \Xtento\ProductExport\Controller\Adminhtml\Manual\Index
 */
class Interceptor extends \Xtento\ProductExport\Controller\Adminhtml\Manual\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Backend\App\Action\Context $context, \Xtento\ProductExport\Helper\Module $moduleHelper, \Xtento\XtCore\Helper\Cron $cronHelper, \Xtento\ProductExport\Model\ResourceModel\Profile\CollectionFactory $profileCollectionFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Xtento\ProductExport\Model\ProfileFactory $profileFactory)
    {
        $this->___init();
