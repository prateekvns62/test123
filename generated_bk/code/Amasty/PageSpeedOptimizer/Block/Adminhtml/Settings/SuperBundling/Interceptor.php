...
class Interceptor extends \Amasty\PageSpeedOptimizer\Block\Adminhtml\Settings\SuperBundling implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Amasty\PageSpeedOptimizer\Model\ConfigProvider $configProvider, \Magento\Framework\Url $url, \Magento\Backend\Block\Template\Context $context, array $data = array())
    {
        $this->___init();
        parent::__construct($configProvider, $url, $context, $data);
    }
